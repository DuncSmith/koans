...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # 
    # Combines the elements of an array can be passed a block or a method (via a :symbol)
    # to describe the operation. the "item" is passed back it the end of the iteration.
  end
